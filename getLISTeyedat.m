function getLISTeyedat(cortexfile,ITMFile,CNDFile,imageX,imageY,imgset)
...
for i = 1:size(eyedat,2);
    ...
    if length(x) > 2120 %500 ms cross hair + 10000 ms for image + 100 ms buffer
...
save(['C:\Users\seth.koenig\Documents\MATLAB\IOR\Eye Data\LIST\'...
    cortexfile(end-9:end) '-fixation.mat'],'images','fixationstats',...
    'notattended','imgset')
end